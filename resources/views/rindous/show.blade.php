    ...
    <div class="position-relative">
        <div class="container-xl position-absolute z-3 d-block m-auto bottom-0 start-0 end-0 text-light">
            <div class="link_nav my-1 my-md-5">
                ...
                <span class="text-shadow mx-1 mx-md-3 fs-6 fs-ms-5">></span>
                <span class="text-shadow fs-6 fs-md-5">{{ $rindou->name }}</span>
            </div>
            <div class="d-block d-md-flex align-items-center mb-0 mb-md-5">
                <h2 class="text-shadow fw-bold fs-3 fs-md-1">{{ $rindou->name }}</h2>
        ...
        <div class="my-5">
            @if (!empty($posts))
                <div class="d-md-flex align-items-md-center justify-content-md-between">
                    <div class="d-block d-md-flex align-items-center my-1 my-md-5 text-center text-md-start">
                        <h3 class="fs-3 fw-bold">< {{ $rindou->name }}に関する投稿 ></h3>
                        <span class="fs-4 fw-bold ms-2 ms-md-5 pb-2">{{ $count }}件</span>
                    </div>
            ...
            @else
                <div class="d-block d-md-flex align-items-center my-5 text-center text-md-start">
                    <h3 class="fs-3 fw-bold">< {{ $rindou->name }}に関する投稿 ></h3>
                    <span class="fs-4 ms-2 ms-md-5">{{ $count }}件</span>
                </div>
                <div class="d-flex d-md-block justify-content-center">
                    <p class="fs-5 lh-lg">
