    ...
    <div class="position-relative mt-4 mt-lg-0">
        <div class="swiper detailpage_img_thumbnail">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="{{ Storage::disk('s3')->url('img/nishizawasenn.jpg') }}" alt="林道の画像" class="img-fluid slide_img"></div>
                <div class="swiper-slide"><img src="{{ Storage::disk('s3')->url('img/mitisakanahatasenn.jpg') }}" alt="林道の画像" class="img-fluid slide_img"></div>
                <div class="swiper-slide"><img src="{{ Storage::disk('s3')->url('img/togawarindou_1.jpg') }}" alt="林道の画像" class="img-fluid slide_img"></div>
                <div class="swiper-slide"><img src="{{ Storage::disk('s3')->url('img/mitisakanahatasenn_2.jpg') }}" alt="林道の画像" class="img-fluid slide_img"></div>
            </div>
        </div>
        ...
        <div class="my-5">
            <div class="d-flex justify-content-center my-5">
                <div class="d-flex align-items-center">
                    <img class="header_icon" src="{{ Storage::disk('s3')->url('img/icon.svg') }}" alt="林道のアイコン画像">
        ...
        <div class="my-5">
            ...
            <div class="row gx-lg-5">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <img src="{{ Storage::disk('s3')->url('img/map_toppage.jpeg') }}" alt="マップの画像" class="w-100 h-75 object-fit-cover">
                    <div class="my-3">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <img src="{{ Storage::disk('s3')->url('img/post_toppage.png') }}" alt="写真を撮影している画像" class="w-100 h-75 object-fit-cover">
                    <div class="my-3">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <img src="{{ Storage::disk('s3')->url('img/clear_toppage.jpeg') }}" alt="走行済みの林道一覧の画像" class="w-100 h-75 object-fit-cover">
                    <div class="my-3">
